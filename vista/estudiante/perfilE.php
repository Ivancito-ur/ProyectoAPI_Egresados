                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <div class="input-group mb-3"
                            ...
                            <div class="custom-file">
                                <input type="file" style="display:none" name="hojaVida" id="hojaVida" class="custom-file-input" id="inputGroupFile01"
                                    aria-describedby="inputGroupFileAddon01">
                                <label class="custom-file-label" for="hojaVida"><p class="nameArchivo">...</p></label>
                            </div>
                        </div>
